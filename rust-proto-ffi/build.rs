...
fn main() {
    ...
    let proto_path = format!("{}{}", env::current_dir().unwrap().to_str().to_owned().unwrap().replace("/rust-proto-ffi", ""), "/proto");
    ...
    prost_build::Config::new()
        ...
        .compile_protos(&[
            "copied_protos/message_ffi.proto",
        ], &["copied_protos"],
        )
        .unwrap();
...
fn gen_type_url(gen_file: &mut File, type_url: &str, type_name: &str) {
    ...
    let tokens = quote! {
        impl crate::core::TypeUrl for #type_name {
